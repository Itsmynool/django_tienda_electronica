...
from app_tienda_electronica.views import home, register, login, custom_logout, home_filtro, add_to_cart, cart, remove_from_cart, compra_carrito, agregar_metodo_pago, compra_directa
